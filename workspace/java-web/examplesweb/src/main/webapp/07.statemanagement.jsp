...
Cookie cookie = 
	new Cookie(	"cookiedata", //쿠키 이름
				URLEncoder.encode(String.format("%d", cookieData + 1), "utf-8")); // 쿠키 데이터
...
<body>
	<a href="07.statemanagement.jsp">새로고침</a>
	&nbsp;&nbsp;
	<a href="07.statemanagement2.jsp">이동</a>
	<hr />
