...
public class ThreadDemoFrame extends JFrame {
	...
	public ThreadDemoFrame() {
		...
		button2.setText("동기 방식 호출 (문제 확인)"); // 버튼 위에 표시되는 메시지
		...
		button4.addActionListener( (e) -> {						// 버튼 클릭하면 호출될 메서드 등록
			System.out.println("1. doWork 호출 전");
			System.out.println("Frame : " + Thread.currentThread().threadId()); // 현재 Thread의 관리 번호 
	...
	public static void main(String[] args) {
		...
		ThreadDemoFrame frame = new ThreadDemoFrame();
